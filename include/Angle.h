...
//****************************************************************************//
static inline flt32_t RadToDeg (flt32_t angle)
{
	return angle * (180.0 / M_PI);
}
static inline flt64_t RadToDeg (flt64_t angle)
{
	return angle * (180.0 / M_PI);
}
...
//****************************************************************************//
static inline flt32_t RadToGrad (flt32_t angle)
{
	return angle * (200.0 / M_PI);
}
static inline flt64_t RadToGrad (flt64_t angle)
{
	return angle * (200.0 / M_PI);
}
...
//****************************************************************************//
static inline flt32_t DegToRad (flt32_t angle)
{
	return angle * (M_PI / 180.0);
}
static inline flt64_t DegToRad (flt64_t angle)
{
	return angle * (M_PI / 180.0);
}
...
//****************************************************************************//
static inline flt32_t DegToGrad (flt32_t angle)
{
	return angle * (200.0 / 180.0);
}
static inline flt64_t DegToGrad (flt64_t angle)
{
	return angle * (200.0 / 180.0);
}
...
//****************************************************************************//
static inline flt32_t GradToRad (flt32_t angle)
{
	return angle * (M_PI / 200.0);
}
static inline flt64_t GradToRad (flt64_t angle)
{
	return angle * (M_PI / 200.0);
}
...
//****************************************************************************//
static inline flt32_t GradToDeg (flt32_t angle)
{
	return angle * (180.0 / 200.0);
}
static inline flt64_t GradToDeg (flt64_t angle)
{
	return angle * (180.0 / 200.0);
}
};
