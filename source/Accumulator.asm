...
;---[Allocate memory for the object]-------
		...
		syscall								; buffer = mmap (NULL, cap, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, -1, 0)
		mov		this, [s_this]				; get "this" variable from the stack
...
;---[Allocate memory for the object]-------
		...
		mov		sc_prm1, 0
		mov		sc_num, SYSCALL_MMAP
		syscall								; buffer = mmap (NULL, source.capacity, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, -1, 0)
		mov		this, [s_this]				; get "this" variable from the stack
